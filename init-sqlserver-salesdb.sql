...
It includes schema creation, table creation, and data insertion for:
- Customers
- Employees
- Products
- Orders
...
WARNING:
Running this script will DROP the 'SalesDB' database if it exists,
permanently deleting all data. Make sure to back up your data.
...
(1, 101, 2, 3, '2025-01-01', '2025-01-05', 'Delivered', '9833 Mt. Dias Blvd.', '1226 Shoe St.', 1, 10, '2025-01-01T12:34:56'),
...
(4, 105, 1, 3, '2025-01-20', '2025-01-25', 'Shipped', '5724 Victory Lane', NULL, 2, 60, '2025-01-20T05:50:33'),
(5, 104, 2, 5, '2025-02-01', '2025-02-05', 'Delivered', NULL, NULL, 1, 25, '2025-02-01T14:02:41'),
(6, 104, 3, 5, '2025-02-05', '2025-02-10', 'Delivered','1792 Bellmont Rd.', NULL, 2, 50, '2025-02-01T15:34:57'),
(7, 102, 1, 1, '2025-02-15', '2025-02-27', 'Delivered','136 Balboa Court','', 2, 30, '2025-02-16T06:22:01' ),
(8, 101, 4, 3, '2025-02-18', '2025-02-27', 'Shipped','2947 Vine Lane', '4311 Clay Rd', 3, 90, '2025-02-16T06:22:01'),
